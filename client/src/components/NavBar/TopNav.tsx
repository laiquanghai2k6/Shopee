            ...
            <div className="flex flex-row justify-between max-md:pb-3 max-md:pt-1 ">
                ...
                <div className="flex flex-row space-x-6 justify-center max-md:space-x-4 max-lg:justify-between max-lg:w-full ">
                    ...
                    {currentUser.name != '' ? (
                        ...
                        <ItemText extraClass="relative" image={currentUser.image} onClick={()=>handleToggleCartModal()} isOpa={false} text={currentUser.name} type="left" icon={Default} isImage={true}  onMouseEnter={() => setOpenSettingModal(true)} onMouseLeave={() => setOpenSettingModal(false)} >
